...
MarkerClusterer.prototype.setupStyles_ = function () {
  ...
  var icons = ['/assets/markerclusterer/m1-5118720be739d6eaaa6c5e9dfce3c6ba3f15838ba5aa5dfec6687bc24bc4413e.png', '/assets/markerclusterer/m2-1ce96fbdfb658c7f14701d93e70b8c7f46cdf10ea8e797b016234fffccbc0171.png', '/assets/markerclusterer/m3-c96a9b48cf0552997f5441b091c62a4389169af4d73f986b3d59c3d938e7a787.png', '/assets/markerclusterer/m4-5c01ee5f7e1f833c80f2404f95b90840a702f12db8ae7fa8e8dbb0dec7e73a42.png', '/assets/markerclusterer/m5-67835702e2a302a178bb6de042ae860e30df5bb41d6f6853902d879ad8bd4ac6.png'];
...
(function() {
  $(document).on('click', '.star a', function(event) {
    return $.ajax({
      url: "/restaurants/add_rate",
      type: "GET",
      dataType: "script",
      contentType: 'json',
      data: {
        rate_data: 11 - $(this).attr('value'),
        rest_id: $(this).attr('id')
      }
    }, (11 - $(this).attr('value')) > 0 && (11 - $(this).attr('value')) < 11 ? $("#rate_" + $(this).attr('id')).html("Rated for: " + (11 - $(this).attr('value'))) : void 0);
  });
